...
- Name: coupon-admin.spec.ts >> FR-17 Coupon Admin >> TC-COUPON-ADMIN-010 boundary rejected
...
Locator:  locator('tbody tr').filter({ hasText: 'HW04_MINIMUM_NEG_CHROMIUM_1786156635420' })
Expected: 0
Received: 1
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('tbody tr').filter({ hasText: 'HW04_MINIMUM_NEG_CHROMIUM_1786156635420' })
