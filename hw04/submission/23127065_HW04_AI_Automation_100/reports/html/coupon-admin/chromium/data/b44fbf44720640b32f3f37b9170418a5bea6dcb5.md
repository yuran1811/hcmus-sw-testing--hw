...
- Name: coupon-admin.spec.ts >> FR-17 Coupon Admin >> TC-COUPON-ADMIN-007 negative rejected
...
Locator:  locator('tbody tr').filter({ hasText: 'HW04_DISCOUNT_NEG_CHROMIUM_1786156625846' })
Expected: 0
Received: 1
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('tbody tr').filter({ hasText: 'HW04_DISCOUNT_NEG_CHROMIUM_1786156625846' })
