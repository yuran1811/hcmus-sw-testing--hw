...
Locator:  locator('tbody tr').filter({ hasText: 'HW04_DISCOUNT_ZERO_FIREFOX_1786156656701' })
Expected: 0
Received: 1
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('tbody tr').filter({ hasText: 'HW04_DISCOUNT_ZERO_FIREFOX_1786156656701' })
