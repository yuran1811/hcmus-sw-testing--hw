...
- Name: product-detail.spec.ts >> FR-06 Product Detail >> TC-PRODUCT-DETAIL-007 negative reject-quantity
...
Locator: getByText(/Số lượng phải là số nguyên/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Số lượng phải là số nguyên/i)
