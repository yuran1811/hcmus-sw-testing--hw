...
- Name: coupon.spec.ts >> FR-09 Coupon >> TC-COUPON-013 boundary SAVE10
...
Locator: getByText('Tiết kiệm: 30,000 ₫')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Tiết kiệm: 30,000 ₫')
...
- main:
  ...
  - paragraph:
    - text: "Thành tiền:"
    - strong: 3,000,010 ₫
  - text: "Tổng thanh toán: 3,000,010 ₫"
