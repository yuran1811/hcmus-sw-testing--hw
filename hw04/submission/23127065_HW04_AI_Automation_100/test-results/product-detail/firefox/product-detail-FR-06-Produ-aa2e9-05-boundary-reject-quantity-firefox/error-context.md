...
- Name: product-detail.spec.ts >> FR-06 Product Detail >> TC-PRODUCT-DETAIL-005 boundary reject-quantity
...
Locator: getByText(/Số lượng tối thiểu là 1/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Số lượng tối thiểu là 1/i)
