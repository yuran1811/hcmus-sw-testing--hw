...
- Name: product-detail.spec.ts >> FR-06 Product Detail >> TC-PRODUCT-DETAIL-009 negative reject-quantity
...
Locator: getByText(/Số lượng không hợp lệ/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Số lượng không hợp lệ/i)
