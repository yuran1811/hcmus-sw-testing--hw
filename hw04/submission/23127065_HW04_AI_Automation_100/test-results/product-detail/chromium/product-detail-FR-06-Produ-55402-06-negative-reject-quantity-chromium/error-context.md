...
- Name: product-detail.spec.ts >> FR-06 Product Detail >> TC-PRODUCT-DETAIL-006 negative reject-quantity
...
Locator: getByText(/Số lượng phải là số nguyên dương/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Số lượng phải là số nguyên dương/i)
