...
- Name: product-detail.spec.ts >> FR-06 Product Detail >> TC-PRODUCT-DETAIL-008 negative reject-quantity
...
Locator: getByText(/Vui lòng nhập số lượng/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Vui lòng nhập số lượng/i)
