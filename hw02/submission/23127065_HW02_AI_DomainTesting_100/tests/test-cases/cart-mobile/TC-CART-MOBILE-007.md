# TC-CART-MOBILE-007: Thêm sản phẩm với số lượng không phải số ("abc") -> tự chuẩn hóa về 1
...
3. Tại trang chi tiết sản phẩm, nhập `"abc"` vào ô nhập số lượng.
...
- Trên màn hình Giỏ hàng, "Sản phẩm A" hiển thị số lượng là 1 (hệ thống tự động chuẩn hóa chuỗi không phải số về 1). Thành tiền hiển thị `100.000 ₫`.
