# TC-CART-MOBILE-010: Sửa số lượng trực tiếp trong giỏ thành số âm (-1) -> tự chuẩn hóa về 1
...
- Hệ thống không chấp nhận số lượng âm và tự động đặt/chuẩn hóa số lượng về giá trị tối thiểu là 1.
