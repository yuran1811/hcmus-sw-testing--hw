# TC-CART-MOBILE-013: Sửa số lượng trực tiếp trong giỏ thành không phải số ("abc") -> tự chuẩn hóa về 1
...
3. Thay đổi giá trị thành `"abc"`.
4. Quan sát số lượng hiển thị thực tế trên ô nhập và thành tiền.

## Expected Result

- Hệ thống không chấp nhận chuỗi không phải số và tự động chuẩn hóa số lượng về giá trị tối thiểu là 1.
