# TC-CART-MOBILE-018: Thêm sản phẩm từ trang chi tiết với số lượng = 1 (BVA ON) -> thành công
...
- Trên màn hình Giỏ hàng, "Sản phẩm A" hiển thị số lượng là 1. Thành tiền hiển thị `100.000 ₫`.
