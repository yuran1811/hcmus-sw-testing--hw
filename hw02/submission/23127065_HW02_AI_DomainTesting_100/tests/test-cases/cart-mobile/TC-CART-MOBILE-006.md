# TC-CART-MOBILE-006: Thêm sản phẩm với số lượng rỗng ("") -> tự chuẩn hóa về 1
...
3. Tại trang chi tiết sản phẩm, xóa trắng ô nhập số lượng để giá trị là rỗng.
...
- Trên màn hình Giỏ hàng, "Sản phẩm A" hiển thị số lượng là 1 (hệ thống tự động chuẩn hóa chuỗi rỗng về 1). Thành tiền hiển thị `100.000 ₫`.
