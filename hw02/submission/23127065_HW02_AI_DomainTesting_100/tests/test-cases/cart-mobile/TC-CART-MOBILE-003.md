# TC-CART-MOBILE-003: Thêm sản phẩm với số lượng = 0 -> tự chuẩn hóa về 1
...
3. Tại trang chi tiết sản phẩm, nhập số lượng `0` vào ô nhập số lượng.
...
- Trên màn hình Giỏ hàng, "Sản phẩm A" hiển thị số lượng là 1 (hệ thống tự động chuẩn hóa số lượng 0 về 1). Thành tiền hiển thị `100.000 ₫`.
