# TC-CART-MOBILE-005: Thêm sản phẩm với số lượng thập phân (1.5) -> tự chuẩn hóa về 1
...
3. Tại trang chi tiết sản phẩm, nhập số lượng `1.5` vào ô nhập số lượng.
...
- Trên màn hình Giỏ hàng, "Sản phẩm A" hiển thị số lượng là 1 (hệ thống sử dụng hàm parseInt để lấy phần nguyên của `1.5` và thu được số lượng 1). Thành tiền hiển thị `100.000 ₫`.
