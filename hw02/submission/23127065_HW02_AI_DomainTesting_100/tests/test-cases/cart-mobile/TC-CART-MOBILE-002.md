# TC-CART-MOBILE-002: Thêm sản phẩm từ trang chi tiết với số lượng hợp lệ (2) -> thành công
...
- Trên màn hình Giỏ hàng, "Sản phẩm A" hiển thị số lượng là 2, đơn giá `100.000 ₫`, thành tiền `200.000 ₫`, và Tổng tạm tính là `200.000 ₫`.
